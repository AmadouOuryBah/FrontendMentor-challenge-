    ...
    return(
        <main>
            <div className="main-title">
                    ...
                    <p>Track how your links are performing accross the web with<br/>
                    <span>our advanced Statistics dashboard</span> </p>
            </div>
            ...
            <div className="main-content">
                   <div className="card-bg ">
                        ...
                        <h3>Band Recognition</h3>
                        <p>boost your brand recognition with <br/>each click
                            Generics links don't mean a<br/> thing.Branded links help instil<br/>
                   ...
                   <div className="card-bg ">
                        ...
                        <p>Gain insights into who is clicking your<br/>
                          ...
                          people engage with your content<br/> helps infrom better decisions.
                        </p>
                   </div>
                   ...
                   <div className="card-bg ">
                        ...
                        <p>Improve brand awareness and<br/>
